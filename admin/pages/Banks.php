                        ...
                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                            ...
                            <table class="invoice-list-table table dataTable no-footer dtr-column"
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            ...
                                            aria-label="Client: activate to sort column ascending">Banka Adı</th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            colspan="1" style="width: 73px;"
                                            aria-label="Total: activate to sort column ascending">Hesap Sahibi</th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            colspan="1" style="width: 73px;"
                                            aria-label="Total: activate to sort column ascending">Iban</th>
                                ...
                                <tbody id="list">
                                    ...
                                    $bak = $DB->prepare("select * from banks");
                                    $bak->execute(array());
                                    $toplam= $bak->rowCount();
                                    $limit = 10;
                                    ...
                                    $forlimit = 1; ?>
                                     <?php $banks = $DB->query("SELECT * from banks order by id desc limit $goster,$limit")->fetchAll(PDO::FETCH_ASSOC); 
                                    foreach ($banks as $banksCek) {
                                        ?>
                                    <tr class="odd">
                                        <td class=" control" tabindex="0" style="display: none;"></td>
                                        <td class="sorting_1">
                                            <a class="fw-bold">#<?=$banksCek['id']?></a>
                                        </td>
                                            ...
                                            <div class="d-flex justify-content-left align-items-center">
                                                <div class="d-flex flex-column">
                                                    <h6 class="user-name text-truncate mb-0">
                                                        <?=$banksCek['bankName']?></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <?=$banksCek['bankAccountName']?>
                                        </td>
                                        <td>
                                            <?=$banksCek['bankIban']?>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center col-actions">
                                                <a class="me-25" href="bank/<?=$banksCek['id']?>"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                                    data-bs-original-title="Banka Düzenle"
                                                    aria-label="Banka Düzenle">
                                                ...
                                                <a class="bankSil" bankID="<?=$banksCek['id']?>" style="margin-left:20px" class="me-25" 
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                                    data-bs-original-title="Banka Sil"
                                                    aria-label="Banka Sil">
