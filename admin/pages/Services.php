                            ...
                            <table class="invoice-list-table table dataTable no-footer dtr-column"
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            colspan="1" style="width: 73px;"
                                            aria-label="Total: activate to sort column ascending">İşlem Süresi</th>
                                ...
                                <tbody id="list">
                                    ...
                                    $forlimit = 1; ?>
                                                        <?php $services = $DB->query("SELECT * from services order by id desc limit $goster,$limit")->fetchAll(PDO::FETCH_ASSOC); 
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center col-actions">
                                                <a class="me-25" href="services/<?=$service['id']?>"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                                    data-bs-original-title="Hizmeti Düzenle"
                                                ...
                                                <a class="hizmetSil" hizmetID="<?=$service['id']?>" style="margin-left:20px" class="me-25" 
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                                    data-bs-original-title="Hizmeti Sil"
                                                    aria-label="Hizmeti Düzenle">
