                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="profilGuncelleForm" class="form form-horizontal">
                                <div class="d-flex">
                                    <a href="#" class="me-25">
                                        <img src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/images/profile/<?php if(empty($providerChk['photo'])){echo 'no-photo.png';}else{echo $providerChk['photo'];} ?>" id="account-upload-img" class="uploadedAvatar rounded me-50" alt="profile image" height="100" width="100" />
                                    </a>
                                ...
                                <div style="margin-top:20px"></div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                <div class="col-sm-3">
                                                    <label class="col-form-label" for="name">Ad Soyad</label>
                                                </div>
                                                <div class="col-sm-9">
                                                    <input type="text" id="name" class="form-control" name="name"
                                                        placeholder="Ad Soyad" value="<?=$provider['name']?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                <div class="col-sm-3">
                                                    <label class="col-form-label" for="password">Şifre
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                <div class="col-sm-3">
                                                    <label class="col-form-label" for="services">Verdiğim
                                                        Hizmetler</label>
                                                </div>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                <div class="col-sm-3">
                                                    <label class="col-form-label" for="w1">Çalışma Saatlerim (Güncellemek
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                <div class="col-sm-3">
                                                    <label class="col-form-label" for="breakTime">Tatil Günlerim</label>
                                                </div>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                <div class="col-sm-3">
                                                    <label class="col-form-label" for="renk">Renk Kodum</label>
                                                </div>
                                                <div class="col-sm-9">
                                                    <input type="color" id="renk" class="form-control" name="renk"
                                        ...
                                        <div class="col-12 ">
                                            <div class="mb-1 row">
                                                <div class="col-sm-3">
                                                    <label class="form-label" for="alindiTemplate">Çalışma Durumum
                                                        (Randevu almak için açınız)</label>
                                                </div>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="col-12 ">
                                            <div class="mb-1 row">
                                                <div class="col-sm-3">
                                                    <label class="form-label" for="alindiTemplate">Çalışmadığım Gün Aralıkları (Açarsanız günleri doldurunuz. Açılınca o günler randevuya kapatılır.)</label>
                                                </div>
                                                <div class="col-sm-9">
                                                    <div class="form-check form-switch form-check-primary">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                <div class="col-sm-3">
                                                    <label class="col-form-label" for="break_start_time">Çalışmadığım Günler (Güncellemek
                                                        için iki alanıda yeniden seçin)</label>
                                                </div>
                                        ...
                                        <div class="col-sm-9 offset-sm-3">
                                            ...
                                            <input type="hidden" name="profilDuzenle" value="1">
                                            <button id="profilDuzenle" type="button"
