...
<head>
    ...
    <title><?=$settings['siteName']?> - Yeni Şifre Belirle</title>
    ...
    <!-- BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/assets/css/style.css">
    <!-- END: Custom CSS-->
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="index.html">
                            ...
                            <h2 class="brand-text text-primary ms-1">Adem Yılmaz</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/images/pages/reset-password-v2.svg" alt="Register V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Reset password-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">Şifre Oluşturma 🔒</h2>
                                <p class="card-text mb-2">Lütfen daha önce kullanmadığınız yeni bir şifre oluşturun.</p>
                                <form class="auth-reset-password-form mt-2" action="auth-login-cover.html" method="POST">
                                    <div class="mb-1">
                                        <div class="d-flex justify-content-between">
                                            <label class="form-label" for="reset-password-new">Yeni Şifre</label>
                                        </div>
                                    ...
                                    <div class="mb-1">
                                        <div class="d-flex justify-content-between">
                                            <label class="form-label" for="reset-password-confirm">Yeni Şifre Tekrar</label>
                                        </div>
                                        <div class="input-group input-group-merge form-password-toggle">
                                    ...
                                    <button class="btn btn-primary w-100" tabindex="3">Şifreni Kaydet</button>
                                </form>
                                <p class="text-center mt-2"><a href="login"><i data-feather="chevron-left"></i> Giriş Yap</a></p>
                            </div>
                        </div>
                        <!-- /Reset password-->
                    </div>
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/js/scripts/pages/auth-reset-password.js"></script>
    <!-- END: Page JS-->
