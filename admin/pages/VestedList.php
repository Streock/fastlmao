    ...
    <div class="content-wrapper container-xxl p-0">
        ...
        <div class="content-body">
                ...
                <div class="card-header border-bottom">
                        <h4 class="card-title">Hakedişler</h4>
                    </div>
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            ...
                                            aria-label="Total: activate to sort column ascending">Tarih</th>
                                    </tr>
                                </thead>
                                <tbody id="list">
                                    ...
                                    $bak = $DB->prepare("select * from vested");
                                    $bak->execute(array());
                                    $toplam= $bak->rowCount();
                                    $limit = 10;
                                    ...
                                    $forlimit = 1; ?>
                                    <?php $vested = $DB->query("SELECT * from vested order by id desc limit $goster,$limit")->fetchAll(PDO::FETCH_ASSOC); 
                                    foreach ($vested as $vestedCek) {
                                        ?>
                                    <tr class="odd">
                                        <td class=" control" tabindex="0" style="display: none;"></td>
                                        <td class="sorting_1">
                                            <a class="fw-bold">#<?=$vestedCek['id']?></a>
                                        </td>
                                        <td>
                                            <div class="d-flex justify-content-left align-items-center">
                                                <div class="d-flex flex-column">
                                                    ...
                                                    $providerCheck->execute(array($vestedCek['providerID']));
                                                    $providerCheckVeri = $providerCheck->fetch(PDO::FETCH_ASSOC);    ?>
                                                    <?=$providerCheckVeri['name']?></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
