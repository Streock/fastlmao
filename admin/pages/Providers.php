                            ...
                            <div class="row d-flex justify-content-between align-items-center m-1">
                                ...
                                <div
                                    ...
                                    <div id="DataTables_Table_0_filter" class="dataTables_filter">
                                        <label>Arama <input id="search" type="search" class="form-control" placeholder="Çalışan Ara"
                            ...
                            <table class="invoice-list-table table dataTable no-footer dtr-column"
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                        colspan="1" style="width: 73px;"
                                        aria-label="Total: activate to sort column ascending">Hakediş</th>
                                        <?php } ?>
                                ...
                                <tbody id="list">
                                    ...
                                    <tr class="odd">
                                        ...
                                        <?php if($settings['vestedSystem']=='1'){ ?>
                                        <td>
                                        <?php if(empty($providerCek['vestedAmount'])){
                                            echo '0₺';
                                        }else{ ?>
                                        <?=$providerCek['vestedAmount']."₺"?>
                                        <?php }?>
                                        </td>
                                        <?php }?>
                                        ...
                                        <td>
                                            ...
                                            <?php if($settings['vestedSystem']=='1'){ ?>
                                            <a class="vestedPayed me-25" providerID="<?=$providerCek['id']?>"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                                    data-bs-original-title="Hakediş Öde"
                                                    aria-label="Hakediş Öde">                                                  
                                                ...
                                                <?php } ?>
                                                <a class="me-25" href="provider/<?=$providerCek['id']?>"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                                    data-bs-original-title="Çalışan Düzenle"
                                                    aria-label="Çalışan Düzenle">
                                                ...
                                                <a class="providerSil" providerID="<?=$providerCek['id']?>" style="margin-left:20px" class="me-25" 
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                                    data-bs-original-title="Çalışan Sil"
