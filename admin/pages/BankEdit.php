...
<?php
$id = $_GET['id'];
$bank = $DB->query("SELECT * from banks where id='$id'")->fetch(PDO::FETCH_ASSOC);
                    ...
                    <div class="col-md-6 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Banka Düzenleme</h4>
                            </div>
                            <div class="card-body">
                            <form id="bankaEkleForm" class="form form-horizontal">
                                    <div class="row">
                                            ...
                                            <div class="mb-1 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="bankName" class="form-control"
                                                        name="bankName" placeholder="Banka Adı" value="<?=$bank['bankName']?>"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="bankAccountName" class="form-control"
                                                        name="bankAccountName" placeholder="Hesap Sahibi Adı" value="<?=$bank['bankAccountName']?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="bankCode" class="form-control"
                                                        name="bankCode" placeholder="Şube Kodu" value="<?=$bank['bankCode']?>"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="bankAccountCode" class="form-control"
                                                        name="bankAccountCode" placeholder="Banka Hesap Numarası" value="<?=$bank['bankAccountCode']?>"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="mb-1 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="bankIban" class="form-control"
                                                        name="bankIban" placeholder="Banka Iban" value="<?=$bank['bankIban']?>"/>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="form-check form-switch form-check-primary">
                                                        <input type="checkbox" class="form-check-input" id="bankStatus"
                                                            name="bankStatus" <?php if($bank['bankStatus']=='1'){echo 'checked';} ?>>
                                        ...
                                        <div class="col-sm-9 offset-sm-3">
                                            <input type="hidden" name="bankID" value="<?=$_GET['id']?>">
                                            <input type="hidden" name="bankEdit" value="1">
                                            <button id="bankEdit" type="button"
