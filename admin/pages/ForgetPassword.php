...
<head>
    ...
    <title><?=$settings['siteName']?> - Şifremi Unuttum</title>
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/images/pages/forgot-password-v2.svg" alt="Forgot password V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Forgot password-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">Şifreni mi unuttun? 🔒</h2>
                                <p class="card-text mb-2">Mail adresini girerek, şifre sıfırlama linkini alabilirsin.</p>
                                <form class="auth-forgot-password-form mt-2" action="auth-reset-password-cover.html" method="POST">
                                    ...
                                    <button class="btn btn-primary w-100" tabindex="2">Şifre Sıfırla</button>
                                </form>
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/js/scripts/pages/auth-forgot-password.js"></script>
    <!-- END: Page JS-->
