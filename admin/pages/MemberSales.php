                        ...
                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                            ...
                            <table class="invoice-list-table table dataTable no-footer dtr-column"
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            ...
                                            aria-label="Client: activate to sort column ascending">Ürün Adı</th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            colspan="1" style="width: 73px;"
                                            aria-label="Total: activate to sort column ascending">Sipariş Tarihi</th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            colspan="1" style="width: 73px;"
                                            aria-label="Total: activate to sort column ascending">Ödeme Durumu</th>
                                ...
                                <tbody id="list">
                                    ...
                                    $bak = $DB->prepare("select * from orders WHERE memberID=$memberID");
                                    $bak->execute(array());
                                    $toplam= $bak->rowCount();
                                    $limit = 10;
                                    ...
                                    $forlimit = 1; ?>
                                     <?php $orders = $DB->query("SELECT * from orders WHERE memberID=$memberID order by id desc limit $goster,$limit")->fetchAll(PDO::FETCH_ASSOC); 
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-left align-items-center">
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <?php $urunDeger = explode(",",$ordersCek['products']); ?>    
                                                    <?php foreach ($urunDeger as $urunDegerCek) { ?>
                                                    <?php $products = $DB->query("SELECT * from products WHERE id=$urunDegerCek order by id desc")->fetchAll(PDO::FETCH_ASSOC); 
                                                    foreach ($products as $productsCek) {
                                                        ?>
                                                    <?=$productsCek['ad']?>
                                                    <?php } } ?>
                                                    </h6>
                                        ...
                                        <td>
                                            <?php if($ordersCek['paymentStatus']=='1'){echo "<p style='color:green'>Ödendi</p>";}?> 
                                            <?php if($ordersCek['paymentStatus']=='0'){echo "<p style='color:red'>Ödenmedi</p>";}?>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center col-actions">
                                                <a class="me-25" href="../orders/<?=$ordersCek['id']?>"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                                    data-bs-original-title="Siparişi Düzenle"
                                                ...
                                                <a class="orderSil" orderID="<?=$ordersCek['id']?>" style="margin-left:20px" class="me-25" 
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                                    data-bs-original-title="Siparişi Sil"
