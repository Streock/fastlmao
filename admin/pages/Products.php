                        ...
                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                            <div class="row d-flex justify-content-between align-items-center m-1">
                                ...
                                <div
                                    ...
                                    <div id="DataTables_Table_0_filter" class="dataTables_filter">
                                        <label>Arama <input id="search" type="search" class="form-control" placeholder="Ürün Ara"
                            ...
                            <table class="invoice-list-table table dataTable no-footer dtr-column"
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            ...
                                            aria-label="Total: activate to sort column ascending">Ürün Açıklama</th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                        colspan="1" style="width: 73px;"
                                        aria-label="Total: activate to sort column ascending">Barkod</th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            colspan="1" style="width: 73px;"
                                            aria-label="Total: activate to sort column ascending">Fiyat</th>
                                        <?php if($settings['stockSystem']=='1'){ ?>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                        colspan="1" style="width: 73px;"
                                        aria-label="Total: activate to sort column ascending">Stok</th>
                                        <?php }?>
                                ...
                                <tbody id="list">
                                    ...
                                    $bak = $DB->prepare("select * from products");
                                    $bak->execute(array());
                                    $toplam= $bak->rowCount();
                                    $limit = 10;
                                    ...
                                    $forlimit = 1; ?>
                                       <?php $products = $DB->query("SELECT * from products order by id desc limit $goster,$limit")->fetchAll(PDO::FETCH_ASSOC); 
                                    foreach ($products as $productsCek) {
                                        ?>
                                    <tr class="odd">
                                        <td class=" control" tabindex="0" style="display: none;"></td>
                                        <td class="sorting_1">
                                            <a class="fw-bold">#<?=$productsCek['id']?></a>
                                        </td>
                                       ...
                                       <?php if($settings['stockSystem']=='1'){ ?>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center col-actions">
                                                <a class="me-25" href="products/<?=$productsCek['id']?>"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                                    data-bs-original-title="Ürün Düzenle"
                                                ...
                                                <a class="urunSil" urunid="<?=$productsCek['id']?>" style="margin-left:20px" class="me-25" 
                                                    data-bs-toggle="tooltip" data-bs-placement="top" title=""
                                                    data-bs-original-title="Ürün Sil"
                                                    aria-label="Ürün Sil">
