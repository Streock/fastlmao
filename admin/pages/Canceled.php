        ...
        <div class="content-body">
            <section class="invoice-list-wrapper">
                ...
                <div class="card-header border-bottom">
                                <h4 class="card-title">İptal Edilen Randevular</h4>
                            </div>
                        ...
                        <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                            ...
                            <table class="invoice-list-table table dataTable no-footer dtr-column"
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            ...
                                            aria-label="Total: activate to sort column ascending">Hizmet</th>
                                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                            colspan="1" style="width: 73px;"
                                            aria-label="Total: activate to sort column ascending">Çalışan</th>
                                ...
                                <tbody id="list">
                                    ...
                                    $bak = $DB->prepare("select * from canceled");
                                    $bak->execute(array());
                                    $toplam= $bak->rowCount();
                                    $limit = 10;
                                    ...
                                    $forlimit = 1; ?>
                                       <?php $randevu = $DB->query("SELECT * from canceled order by id desc limit $goster,$limit")->fetchAll(PDO::FETCH_ASSOC); 
                                    foreach ($randevu as $randevuListCek) {
                                        ?>
                                    <tr class="odd">
                                        <td class=" control" tabindex="0" style="display: none;"></td>
                                        <td class="sorting_1">
                                            <a class="fw-bold"><?=$randevuListCek['appDate']?> - <?=$randevuListCek['startTime']?></a>
                                        </td>
                                        ...
                                        <td>
                                        <?php
                                          $id = $randevuListCek['service'];
                                          $service = $DB->query("SELECT * from services where id='$id'")->fetch(PDO::FETCH_ASSOC);?>
                                            <?=$service['serviceName']?>
                                        </td>
                                        <td>
                                        <?php
                                          $id = $randevuListCek['providerID'];
