<div class="sidenav-overlay"></div>
    ...
    <script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/vendors/js/charts/apexcharts.min.js"></script>
    <script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/vendors/js/extensions/toastr.min.js"></script>
    <script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/vendors/js/calendar/fullcalendar.min.js"></script>
    <script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/vendors/js/calendar/locale-tr.js"></script>

    <script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/vendors/js/extensions/moment.min.js"></script>
    <script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/vendors/js/forms/select/select2.full.min.js"></script>
    ...
    <script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/vendors/js/pickers/pickadate/picker.time.js"></script>

    
    <script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/vendors/js/tables/datatable/jquery.dataTables.min.js"></script>
    <script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/vendors/js/tables/datatable/datatables.buttons.min.js"></script>
    <script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/vendors/js/tables/datatable/dataTables.bootstrap5.min.js"></script>
    <script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/vendors/js/tables/datatable/datatables.checkboxes.min.js"></script>
    <script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/vendors/js/tables/datatable/dataTables.responsive.min.js"></script>
    <script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/vendors/js/tables/datatable/responsive.bootstrap5.js"></script>
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/js/scripts/pages/app-calendar-events.js"></script>
<script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/js/scripts/pages/app-calendar.js?v=2"></script>
<script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/js/scripts/forms/pickers/form-pickers.js"></script>
<script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/js/scripts/pages/page-account-settings-account.js"></script>
    <script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/vendors/js/forms/cleave/cleave.min.js"></script>
    <script src="<?php echo "https://" . $_SERVER['SERVER_NAME']; ?>/admin/app-assets/vendors/js/forms/cleave/addons/cleave-phone.us.js"></script>
  ...
  revenueReportChartOptions = {
    ...
    series: [
      {
        name: 'Gelir',
        data: ['<?=$ocakGelir?>', '<?=$subatGelir?>', '<?=$martGelir?>', '<?=$nisanGelir?>', '<?=$mayisGelir?>', '<?=$haziranGelir?>', '<?=$temmuzGelir?>', '<?=$agustosGelir?>', '<?=$eylulGelir?>', '<?=$ekimGelir?>', '<?=$kasimGelir?>', '<?=$aralikGelir?>']
      },
      {
        name: 'Gider',
        data: ['<?=$ocakGider?>', '<?=$subatGider?>', '<?=$martGider?>', '<?=$nisanGider?>', '<?=$mayisGider?>', '<?=$haziranGider?>', '<?=$temmuzGider?>', '<?=$agustosGider?>', '<?=$eylulGider?>', '<?=$ekimGider?>', '<?=$kasimGider?>', '<?=$aralikGider?>']
      }
    ],
    dataLabels: {
      enabled: false
