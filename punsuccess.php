                        ...
                        <div class="multisteps_form_panel" style="display: block;">
                            ...
                            <div class="form_content">
                                ...
                                <div class="question_title py-5">
                                    ...
                                    <h1 class="text-capitalize"><?=$translations['paymentunsuccess']?></h1>

                                </div>

                            </div>

                            <p class="text-capitalize"><?=$translations['paymentunsuccessinfo']?><p>


                            <div class="form_btn pt-5 d-flex justify-content-between">

                                <a href="payment/<?=$_GET['id']?>"><button type="button" class="next_btn text-uppercase text-white"
                                    ><?=$translations['tryagain']?><span><i
